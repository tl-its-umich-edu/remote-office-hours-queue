...
export const updateQueue = async (
    queue_id: number, name?: string, description?: string, inperson_location?: string, allowed_backends?: Set<string>
) => {
    ...
    if (inperson_location !== undefined) queuePatched['inperson_location'] = inperson_location;
